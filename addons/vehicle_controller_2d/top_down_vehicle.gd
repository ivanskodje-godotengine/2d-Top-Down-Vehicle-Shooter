...
# CUSTOM
var combat_controller = null # Combat Controller, handles shooting and combat
...
func _ready():
	...
	# CUSTOM:
	# Load the vehicle combat controller
	combat_controller = load("res://player/vehicle_combat_controller.gd").new()
